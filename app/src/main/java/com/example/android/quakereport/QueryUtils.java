    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0; i < features.length(); i++) {
                ...
                double magnitude = Double.valueOf(formatter.format(mag));
                ...
                // Adding new Earthquake Obhject to earthquakes ArrayList
                earthquakes.add(new Earthquake(magnitude,place,dateToDisplay,timeToDisplay,url));
            }
